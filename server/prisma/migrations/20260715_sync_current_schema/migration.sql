...
ADD COLUMN     "accountPasswordAuthTag" TEXT,
ADD COLUMN     "accountPasswordCiphertext" TEXT,
ADD COLUMN     "accountPasswordEncryptedKey" TEXT,
ADD COLUMN     "accountPasswordIv" TEXT,
ADD COLUMN     "accountPasswordUpdatedAt" TIMESTAMP(3),
ADD COLUMN     "addonPrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
ADD COLUMN     "amountCents" INTEGER,
ADD COLUMN     "appearOffline" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "basePrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
ADD COLUMN     "bonusWin" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "boostType" TEXT NOT NULL,
ADD COLUMN     "cashAmountCents" INTEGER,
ADD COLUMN     "currency" TEXT NOT NULL DEFAULT 'cad',
ADD COLUMN     "currentLP" TEXT,
ADD COLUMN     "currentMasterLp" INTEGER,
ADD COLUMN     "currentRank" TEXT,
ADD COLUMN     "desiredMasterLp" INTEGER,
ADD COLUMN     "desiredRank" TEXT,
ADD COLUMN     "desiredWins" INTEGER,
ADD COLUMN     "firstRole" TEXT,
ADD COLUMN     "goldDiscountCents" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "goldRedeemed" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "highMMRDuo" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "inGameName" TEXT,
ADD COLUMN     "liveStream" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "lpGain" TEXT,
ADD COLUMN     "numberOfGames" INTEGER,
ADD COLUMN     "paidAt" TIMESTAMP(3),
ADD COLUMN     "paymentStatus" "PaymentStatus" NOT NULL DEFAULT 'PENDING',
ADD COLUMN     "peakRank" TEXT,
ADD COLUMN     "placementGames" INTEGER,
ADD COLUMN     "playMode" TEXT,
ADD COLUMN     "premiumCoaching" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "priorityOrder" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "queueType" TEXT,
ADD COLUMN     "region" TEXT,
ADD COLUMN     "secondRole" TEXT,
ADD COLUMN     "selectedChampions" JSONB,
ADD COLUMN     "soloOnly" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "stripeCheckoutSessionId" TEXT,
ADD COLUMN     "stripePaymentIntentId" TEXT,
ADD COLUMN     "totalPrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
ADD COLUMN     "trustpilotReviewSentAt" TIMESTAMP(3);

-- AlterTable
ALTER TABLE "Profile" ADD COLUMN     "birthday" TIMESTAMP(3),
