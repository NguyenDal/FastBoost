...
function MatchPageSkeleton() {
    return (
        <div className="match-loading-page">
            <section className="match-loading-card match-loading-hero">
                <Skeleton width={180} height={10} />
                <div style={{ height: 22 }} />
                <Skeleton width="min(430px, 70%)" height={42} radius={18} />
                <div style={{ height: 18 }} />
                <Skeleton width="min(620px, 82%)" height={16} />
            </section>
            ...
            <div className="match-loading-layout">
                <section className="match-loading-main">
                    <div className="match-loading-card match-loading-chat">
                        <div className="match-loading-chat-header">
                            ...
                            <SkeletonButton width={150} className="match-loading-status-pill" />
                        </div>

                        <div className="match-loading-message">
                            <SkeletonCircle size={38} />

                            <div className="match-loading-bubble">
                        ...
                        <div className="match-loading-message match-loading-message-right">
                            <div className="match-loading-bubble match-loading-bubble-right">
                                <Skeleton width="66%" height={11} />
                                <div style={{ height: 10 }} />
                    ...
                    <div className="match-loading-card match-loading-options">
                        <Skeleton width={180} height={20} />
                        <div style={{ height: 18 }} />

                        <div className="match-loading-option-grid">
                            {Array.from({ length: 4 }).map((_, index) => (
                                <Skeleton key={index} height={58} radius={999} />
                            ))}
                        </div>
                    </div>
                </section>
                ...
                <aside className="match-loading-sidebar">
                    <div className="match-loading-card match-loading-side-card">
                        <SkeletonCircle size={78} className="match-loading-centered" />
                        <div style={{ height: 16 }} />
                        <Skeleton width={190} height={18} className="match-loading-centered" />
                        <div style={{ height: 10 }} />
                        <Skeleton width="80%" height={12} className="match-loading-centered" />
                        <div style={{ height: 10 }} />
                        <Skeleton width="65%" height={12} className="match-loading-centered" />
                    </div>

                    <div className="match-loading-card match-loading-side-card">
                        <Skeleton width={180} height={20} />
                        <div style={{ height: 18 }} />
                        <Skeleton height={58} radius={999} />
                        <div style={{ height: 14 }} />
                        <Skeleton height={58} radius={999} />
                    </div>
